...
HARNESS_SCRIPTS="common.sh preflight.sh restore.sh backup.sh update.sh upgrade.sh downgrade.sh trigger.sh monitor.sh diagnose.sh fix.sh health.sh recover.sh init-services.sh"
